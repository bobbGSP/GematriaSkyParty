...
function Populate_MenuBar() {
	...
	hStr += '<div class="MenuLink3"><a href="https://gematriaresearch.blogspot.com/" target="_blank">Gematria Research</a></div>'
	hStr += '<BR>'
	hStr += '<BR>'
...
function Open_Ciphers(impOpt = cOption, impBool = false) {
	...
	if (cOption == "Custom") {
		...
		hStr += '<button class="CipherButton" onclick="Add_BaseCiphers(true)" value="BaseCiphers"><B>Base 4</B></button>'
